...
```{r select-expected-possum-participants, include=T, eval=T}
...
```{r select-alternative-possum-participants, include=F, eval=F}
...
```
\newpage 
```{r possum-step-analysis-2-graphic, include=T, eval=T}
...
```{r possum-step-analysis-3, include=F, eval=F}
