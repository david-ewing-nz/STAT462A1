...
```{r format-possums, include=T, eval=T}
pskim_ft = skim_flextable(possums)
pskim_ft
```

Plotting age vs totle

```{r possum-scatterplot1}
...
```{r possums-convert1, include=T , eval=T}
set.seed(82171165) 
...
```{r format_comparison, include=F, eval=T}
...
```{r print-tables, include=T, eval=T}
...
```{r possum-data-splitting, include=T , eval=T}
...
```{r format-split, include=F, eval=T}
