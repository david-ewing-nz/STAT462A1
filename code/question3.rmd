...
phistograms <- ggplot(possums_long, aes(x = Value)) +
  ...
  theme_minimal() +
  labs(title = "Histograms and Density Plots of Numeric Features",
       x = "Value",
       y = "Density")
...
correlation_long <- p_matrix1 |> 
  as.data.frame() |> 
  rownames_to_column(var = "Variable1") |> 
  pivot_longer(cols = -Variable1, names_to = "Variable2", values_to = "Correlation")

# Create a correlation heatmap using ggplot
p_correlation_heatmap <- ggplot(correlation_long, aes(x = Variable1, y = Variable2, fill = Correlation)) +
