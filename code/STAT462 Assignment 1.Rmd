...
params:
  pthreshold: 0.25  # DEE: pthreshold is a parameter for possum correlation. 
                    ...
                    # It is a parameter than will be tweaked by the user 
                    # if/when the data is updated in subsequent runs.  
output:
  pdf_document:
...
```{r load-dataset, eval=T, include=FALSE }
# Load and preprocess dataset
# eval=TRUE, as agreeded on 20250313. 
