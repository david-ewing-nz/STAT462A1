...
3.  Perform a linear regression of type `income = b0 + b1 * children` for analysing the influence on `children` on `income`.
    ...
    2.  What is the predicted mean income of a household with 𝑛n children, for 𝑛∈{0,1,…,8}n∈{0,1,…,8}? What are the associated 90% prediction intervals? Summarise all of this in a table.
...
2.  What is the predicted mean income of a household with $𝑛$ children, for $\text{n} ∈ \{0,1,…,8\}$? What are the associated 90% prediction intervals? Summarise all of this in a table.
